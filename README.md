...
Hermod Niflheim can schedule PostgreSQL backups, SQL Server full/differential/log backups, and guide administrators through AWS S3 or Google Cloud Storage setup. See [docs/backups.md](docs/backups.md), [docs/mssql-backups.md](docs/mssql-backups.md), [docs/backup-storage-setup.md](docs/backup-storage-setup.md), and [docs/backup-storage-layout.md](docs/backup-storage-layout.md) for engine behavior, object-key layout, storage target setup, permissions, and credential safety notes.
